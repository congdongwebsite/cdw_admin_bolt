$(function () {
  ...
  $(document).ready(function () {
    newManageHosting.initialize();
  });
});

var newManageHosting = (function (self, base, details) {
  base.form = $("form.form-new-manage-hosting-small");
  base.action = "ajax_new-manage-hosting";
  ...
  self.initialize = () => {
    ...
    [Gia, GiaHan] = AutoNumeric.multiple(
      [
        "form.form-new-manage-hosting-small" + " #gia",
        "form.form-new-manage-hosting-small" + " #gia_han",
      ],
      siteSettings.OptionAutoNumericAmountVND
    );
