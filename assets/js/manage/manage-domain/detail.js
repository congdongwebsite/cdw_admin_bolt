$(function () {
  ...
  $(document).ready(function () {
    detailManageDomain.initialize();
  });
});

var detailManageDomain = (function (self, base, details) {
  base.form = $("form.form-detail-manage-domain-small");
  base.action = "ajax_update-manage-domain";
  base.actionDelete = "ajax_delete-manage-domain";
  ...
  details.action = "ajax_load-manage-domain-detail";
  ...
  self.initialize = () => {
    ...
    [Gia, GiaHan] = AutoNumeric.multiple(
      [
        "form.form-detail-manage-domain-small" + " #gia",
        "form.form-detail-manage-domain-small" + " #gia_han",
      ],
