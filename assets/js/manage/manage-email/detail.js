$(function () {
  ...
  $(document).ready(function () {
    detailManageEmail.initialize();
  });
});

var detailManageEmail = (function (self, base, details) {
  base.form = $("form.form-detail-manage-email-small");
  base.action = "ajax_update-manage-email";
  base.actionDelete = "ajax_delete-manage-email";
  ...
  details.action = "ajax_load-manage-email-detail";
  ...
  self.initialize = () => {
    ...
    [Gia, GiaHan] = AutoNumeric.multiple(
      [
        "form.form-detail-manage-email-small" + " #gia",
        "form.form-detail-manage-email-small" + " #gia_han",
      ],
