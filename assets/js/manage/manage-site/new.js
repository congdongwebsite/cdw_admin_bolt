$(function () {
  ...
  $(document).ready(function () {
    newManageSite.initialize();
  });
});

var newManageSite = (function (self, base) {
  base.form = $("form.form-new-manage-site-small");
  base.action = "ajax_new-manage-site";
  ...
  self.saveThumbnail = (id) => {
    ...
    formData.append("action", "ajax_new-thumbnail-manage-site");
  ...
  self.saveImage = (id) => {
    ...
    var formData = new FormData();
    formData.append("action", "ajax_new-image-manage-site");
    formData.append("security", base.security);
    formData.append("id", id);
  ...
  self.initialize = () => {
    ...
    [Price] = AutoNumeric.multiple(
      ["form.form-new-manage-site-small #price"],
