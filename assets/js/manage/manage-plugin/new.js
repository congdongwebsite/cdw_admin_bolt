$(function () {
  ...
  $(document).ready(function () {
    newManagePlugin.initialize();
  });
});

var newManagePlugin = (function (self, base) {
  base.form = $("form.form-new-manage-plugin-small");
  base.action = "ajax_new-manage-plugin";
  ...
  self.saveThumbnail = (id) => {
    ...
    formData.append("action", "ajax_new-thumbnail-manage-plugin");
  ...
  self.saveImage = (id) => {
    ...
    var formData = new FormData();
    formData.append("action", "ajax_new-image-manage-plugin");
    formData.append("security", base.security);
    formData.append("id", id);
  ...
  self.initialize = () => {
    ...
    [Price] = AutoNumeric.multiple(
      ["form.form-new-manage-plugin-small #price"],
