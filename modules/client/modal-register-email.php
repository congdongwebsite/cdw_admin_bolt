<div class="modal fade" id="modal-configure-email" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="title" id="modal-register-email-title">Đăng ký & Cấu hình Email iNET</h4>
            </div>
                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane" id="step3-finish">
                            <div class="text-center mb-4">
                                <h4>🎉 Hệ thống Email của bạn đã sẵn sàng sửn dụng!</h4>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
