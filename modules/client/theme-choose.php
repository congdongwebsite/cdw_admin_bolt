<div class="client-theme-choose">
    <?php wp_nonce_field('ajax-client-theme-nonce', 'nonce'); ?>
    <div class="card">
        <div class="body">
            <div class="input-group" id="adv-search">
                <input type="text" class="form-control input-theme" placeholder="Nhập theme bạn muốn tìm kiếm ..." required>
        ...
        <div class="body">
            ...
            <div class="tab-content row theme-list">
            </div>
        </div>
    </div>
</div>