                ...
                <div class="row clearfix">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="form-group">
                            ...
                            <select id="new-email-plan" class="form-control select2"></select>
                        </div>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" id="btn-confirm-change-email-plan">Xác nhận đổi gói</button>
