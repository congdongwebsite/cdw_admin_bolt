...
if (isset($_GET['id']) && get_post_status($_GET['id'])) {
    $id_detail = $_GET['id'];
?>
    <form class="form-detail-manage-plugin-small" method="POST">
        <?php wp_nonce_field('ajax-detail-manage-plugin-nonce', 'nonce'); ?>
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    $idPluginTypes = wp_get_post_terms($id_detail, 'plugin-type', $arr);
                                    ?>
                                    <select id='type' name='type' class='select2 form-control' data-value="<?php echo implode(",", $idPluginTypes); ?>" multiple required></select>
                                </div>
                            </div>
                        </div>
