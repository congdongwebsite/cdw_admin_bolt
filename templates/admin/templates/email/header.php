...
<head>
    ...
    <style>
        .form-mail-cdw footer {
            padding: 10px 30px;
            border-top: 2px solid #0c1c3e;
        }

        section.form-mail-cdw .main {
            background: #fff;
        }

        .form-mail-cdw .header>div {
            width: 50%;
        }

        section.form-mail-cdw .content h2 {
            text-align: center;
            font-weight: bold;
        }

        section.form-mail-cdw .mess-ticket {
            border: 1px dashed;
            padding: 10px;
            border-radius: 5px;
            margin-bottom: 10px;
        ...
        section.form-mail-cdw .mess-ticket p {
            margin: 5px;
        }

        .form-mail-cdw .header {
            display: flex;
            display: -webkit-flex;
            display: -ms-flexbox;
            padding: 10px 30px;
        ...
        .form-mail-cdw header img {
            width: 150px;
        }

        .form-mail-cdw header p {
            text-align: right;
        }

        .form-mail-cdw .content {
            padding: 30px;
        }
...
<body>
    <section class="form-mail-cdw">
        <div class="main">
            <header class="header">
                <div><a href="https://www.congdongweb.com/"><img src="https://www.congdongweb.com/wp-content/uploads/2022/11/congdongweb.png" alt="cộng đồng website" style="margin-top:13px;" /></a></div>
                <div>
                    <p>
                        <a href="https://www.congdongweb.com/" target="_blank"><svg fill="#001439" width="15px" height="15px" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg" stroke="#001439">
                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                <g id="SVGRepo_iconCarrier">
                                    <title>Cộng Đồng Web - Ticket New</title>
