$(function () {
  ...
  $(document).ready(function () {
    detailPayment.initialize();
  });
});

var detailPayment = (function (self, base, details) {
  base.form = $("form.form-detail-payment-small");
  base.action = "ajax_update-payment";
  base.actionDelete = "ajax_delete-payment";
  ...
  details.action = "ajax_load-payment-detail";
