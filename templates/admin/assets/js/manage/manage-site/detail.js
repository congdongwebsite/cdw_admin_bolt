$(function () {
  ...
  $(document).ready(function () {
    detailManageSite.initialize();
  });
});

var detailManageSite = (function (self, base) {
  base.form = $("form.form-detail-manage-site-small");
  base.action = "ajax_update-manage-site";
  base.actionDelete = "ajax_delete-manage-site";
  ...
  self.saveThumbnail = (id) => {
    ...
    formData.append("action", "ajax_update-thumbnail-manage-site");
  ...
  self.saveImage = (id) => {
    ...
    var formData = new FormData();
    formData.append("action", "ajax_update-image-manage-site");
    formData.append("security", base.security);
    formData.append("id", id);
  ...
  self.initialize = () => {
    ...
    [Price] = AutoNumeric.multiple(
      ["form.form-detail-manage-site-small #price"],
      siteSettings.OptionAutoNumericAmountVND
    );

    initSelect2SiteType("type", base.form);
    imagesContainer.lightGallery({
      thumbnail: true,
      selector: ".item a.image",
    });
