$(function () {
  ...
  var ticket = (function (self) {
    ...
    self.action = "ajax_get-list-ticket";
    self.security;
    ...
    self.event = () => {
      ...
      $(self.contextList).on("click", ".ticket-archive", (e) => {
        self.ticketArchive(e);
      });
      $(self.contextList).on("click", ".ticket-trash", (e) => {
        self.ticketTrash(e);
      });
      ...
      $(".ticket-detail-expand", self.contextList).on("click", (e) => {
        self.refresh(e);
        self.loadStatus(e);
      });
      $(".ticket-archive", self.contextList).on("click", (e) => {
        self.ticketArchive(e);
      });
      $(".ticket-trash", self.contextList).on("click", (e) => {
        self.ticketTrash(e);
      });
      ...
      $(".ticket-trash-list", self.contextAction).on("click", (e) => {
        let ids = self.getTickIDs();
        if (ids.length == 0) return;
        self.ticketTrashList(ids);
      });
      $(".ticket-delete-list", self.contextAction).on("click", (e) => {
        let ids = self.getTickIDs();
        if (ids.length == 0) return;
        self.ticketDeleteList(ids);
      });
    };

    self.ticketUnreadList = (ids) => {
      let data = {
        action: "ajax_update-unreads-ticket",
        security: self.security,
        ids: ids,
      };
    ...
    self.ticketReadList = (ids) => {
      let data = {
        action: "ajax_update-reads-ticket",
        security: self.security,
        ids: ids,
      };
    ...
    self.ticketPinImportantList = (ids) => {
      let data = {
        action: "ajax_update-importants-ticket",
        security: self.security,
        ids: ids,
      };
    ...
    self.ticketPinUnimportantList = (ids) => {
      let data = {
        action: "ajax_update-unimportants-ticket",
        security: self.security,
        ids: ids,
      };
    ...
    self.ticketTrashList = (ids) => {
      let data = {
        action: "ajax_update-trashs-ticket",
        security: self.security,
        ids: ids,
      };
    ...
    self.ticketDeleteList = (ids) => {
      let data = {
        action: "ajax_update-deletes-ticket",
        security: self.security,
        ids: ids,
      };
    ...
    self.ticketImportant = (e) => {
      ...
      let data = {
        action: "ajax_update-important-ticket",
        security: self.security,
        id: id_ticket,
      };
    ...
    self.ticketArchive = (e) => {
      ...
      let data = {
        action: "ajax_update-archive-ticket",
        security: self.security,
        id: id_ticket,
      };
    ...
    self.ticketTrash = (e) => {
      ...
      let data = {
        action: "ajax_update-trash-ticket",
        security: self.security,
        id: id_ticket,
      };
    ...
    self.loadStatus = () => {
      let data = {
        action: "ajax_load-status-ticket",
        security: self.security,
        status: self.currentStatus,
      };
