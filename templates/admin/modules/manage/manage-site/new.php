...
global $CDWFunc;
?>
<form class="form-new-manage-site-small" method="POST">
    <?php wp_nonce_field('ajax-new-manage-site-nonce', 'nonce'); ?>
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" id="login_user" name="login_user" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="form-group">
