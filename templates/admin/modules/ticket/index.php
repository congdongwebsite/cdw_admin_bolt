...
<div class="card ticket">
    <?php wp_nonce_field('ajax-ticket-nonce', 'nonce'); ?>
                ...
                <div class="float-left">
                    ...
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu ticket-action">
                            ...
                            <a class="dropdown-item ticket-trash-list" href="javascript:void(0);">Chuyển vào thùng rác</a>
                            <a class="dropdown-item ticket-delete-list" href="javascript:void(0);">Xóa vĩnh viễn</a>
                        </div>
                    </div>
                </div>
