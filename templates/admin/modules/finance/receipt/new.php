...
global $CDWFunc;
?>
<form class="form-new-receipt-small" method="POST">
    <?php wp_nonce_field('ajax-new-receipt-nonce', 'nonce'); ?>
    <input type="hidden" id="urlredirect" value="<?php echo $CDWFunc->getUrl('index', 'receipt'); ?>">
            ...
            <div class="row clearfix">
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="form-group">
                        ...
                        <input type="text" id="date" name="date" class="form-control datepicker date-now" required>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="form-group">
