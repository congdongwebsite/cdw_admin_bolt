        ...
        <# } #>
            <# if ( !data.notFound ) { #>
                <tr id="id-{{data.id}}" class="item" data-item="{{data.id}}">
                    ...
                    <td class="quantity text-right"><input type="number" name="quantity" style="width: 80px;" min="0" step="1" id="quantity" value="{{data.quantity}}" class="form-control text-right m-auto"></td>
