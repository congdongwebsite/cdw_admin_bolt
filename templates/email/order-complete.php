...
<p>Cộng Đồng Web nhận được yêu cầu của quý khách về việc mua sản phẩm dịch vụ bên em về mã đơn: <b id="order-cdw">[#<?php echo $id; ?>]</b>, chúng tôi đã tiến hành xử lý và kích hoạt dịch vụ của bạn thành công, bạn có thể kiểm tra đơn hàng của bạn và thông tin đơn hàng qua website bên em để theo giõi.</p>
